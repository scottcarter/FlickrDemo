...
class PhotoViewController: UIViewController {
    ...
    @objc func addBookmarkAction(_ sender: UIBarButtonItem) {
    ...
    override func viewDidLoad() {
        ...
        let addBookmark = UIBarButtonItem(barButtonSystemItem: .add, target: self, action: #selector(addBookmarkAction(_:)))
        
        navigationItem.rightBarButtonItem = addBookmark
